    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo" height="24"/> AYM Shopping Mall
                </h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-6 mt-4">
                    <address>
                        <strong>AYM Shopping Mall:</strong><br>
                        AYM Ungogo Kano<br>
                        aym@gmail.com
                    </address>
                </div>
      ...
      @php
        ...
        @endforeach
            <tr>
                ...
                <td class="thick-line text-end">N{{ $total_sum }}</td>
            </tr>
            <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
                ...
                <td class="no-line text-end">N{{ $payment->discount_amount }}</td>
            </tr>
             <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
                ...
                <td class="no-line text-end">N{{ $payment->paid_amount }}</td>
            </tr>
             ...
             <tr>
                ...
                <td class="no-line text-end">N{{ $payment->due_amount }}</td>
            </tr>
            <tr>
                <td class="no-line"></td>
                 <td class="no-line"></td>
                ...
                <td class="no-line text-end"><h4 class="m-0">N{{ $payment->total_amount }}</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
